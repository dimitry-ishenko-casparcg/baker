...
////////////////////////////////////////////////////////////////////////////////
void device::double_press(std::initializer_list<button> il)
{
    for(auto btn : il) double_press(btn);
}
...
////////////////////////////////////////////////////////////////////////////////
void device::group(std::initializer_list<button> il, int id)
{
    for(auto btn : il) group(btn, id);
}
